...
public class PlayerManager {
    ...
    /**
     * method: updatePlayer
     * parameters: int id, String name, String position, String team, int matches, int goals, int assists, int minutes
     * return: boolean
     * purpose: updates the details of a player with the given Id
     */

    public boolean updatePlayer(int id, String name, String position,
                                String team, int matches,
